...
class BuscadorApp:
        ...
        for archivo in archivos:
            ...
            try:
                with open(ruta_archivo, 'r', encoding='utf-8') as file:
                    ...
                    self.documentos[archivo] = ruta_archivo  # Guardar ruta en lugar del contenido
    ...
    def buscar(self):
        ...
        # Obtener hasta 40 documentos, incluyendo los de similitud 0
        resultados = []
    ...
    def abrir_archivo(self, event):
        try:
            ...
            archivo_seleccionado = self.lista_resultados.get(seleccion[0]).split(" (Similitud")[0]  # Extraer solo el nombre del archivo
            
            ruta_archivo = self.documentos.get(archivo_seleccionado)
            if ruta_archivo and os.path.exists(ruta_archivo):
                webbrowser.open(ruta_archivo)  # Abrir con el programa predeterminado
            else:
